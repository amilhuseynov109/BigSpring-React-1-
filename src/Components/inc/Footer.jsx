...
function Footer() {
  return (
   <section className='bg-[#edf6f5]'>
        <div className='p-3  md:grid lg:grid-cols-4 md:grid-cols-2 md:text-center md:items-center md:justify-center md:max-w-[1200px] md:mx-auto '> 
            <div>
            ...
            <div className='mt-8'>
                    ...
                    <ul className='flex justify-around max-w-[50%] text-2xl text-[#4ca8ca] mt-5 md:mb-20 '>
                        <li>
                            <FaFacebook />
                        </li>
                        <li>
