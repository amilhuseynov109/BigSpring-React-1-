...
function Contact() {
  return (
    <>
    <div><h1 className='text-4xl text-center my-15'>Contact US</h1></div>
    <section className="py-6 dark:bg-gray-100 dark:text-gray-900 ">
        
	<div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x md:mb-10">
		...
		<form noValidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
			...
			<button type="button" className="self-center px-10 py-5 text-xl rounded focus:ring hover:ring focus:ring-opacity-75 bg-[#0aa8a7] dark:text-gray-50 rounded-4xl ">Submit</button>
		</form>
	</div>
</section>
    </>
